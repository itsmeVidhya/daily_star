...
public partial class ABOUT : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       // Label2.Text = Session["uname"].ToString();
        ...
        string s11 = "select * from police1 order by pid desc";// where sid='"+Session["sid"].ToString()+"'";// where status='" + dd.ToString() + "'";// where grp='" + DropDownList1.SelectedItem.Text + "'";// order by pid desc";// where au='" + TextBox1.Text + "' ";
