<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_add_police.aspx.cs" Inherits="ABOUT" %>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        ...
        <ul>
          ...
          <li><a href="admin_view_police.aspx">Police Station</a></li>
           <li><a href="admin_add_police.aspx"  class="active">Add Police Station</a></li>
            <li><a href="admin_criminal.aspx">Criminal</a></li>
                                ...
                                <asp:Panel ID="Panel2" runat="server" BorderColor="" BorderStyle="Solid" 
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            <td colspan="4">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Upload details 
                                                of police station to forward this to police people to view citizen&#39;s complaints.</td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table class="w-100">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="TextBox1" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="Station Name" Width="400px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            <asp:TextBox ID="TextBox17" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="Location" Width="400px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="TextBox3" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="Police in Charge" Width="400px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                                                ControlToValidate="TextBox14" ErrorMessage="Please Fill" 
                                                                ForeColor="#CC0000"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                                                                ControlToValidate="TextBox15" ErrorMessage="Please Fill" 
                                                                ForeColor="#CC0000"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            <asp:TextBox ID="TextBox14" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="Contact Number of Authority" Width="400px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            <asp:TextBox ID="TextBox15" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="Official Address" Width="400px" TextMode="MultiLine"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator11" 
                                                                runat="server" ControlToValidate="TextBox16" ErrorMessage="Invalid emailid" 
                                                                ForeColor="#CC0000" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            &nbsp;Station Photo <asp:RequiredFieldValidator ID="RequiredFieldValidator4" 
