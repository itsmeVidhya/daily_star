<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userhome.aspx.cs" Inherits="ABOUT" %>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="user_complaint.aspx">My News</a></li>
                                ...
                                <asp:Panel ID="Panel2" runat="server" BorderColor="" BorderStyle="Solid" 
                                    ...
                                    <div class="text-center">
                                        <div class="">
                                            ...
                                            <br />
                                            <h2>
                                                Welcome <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></h2>
                                        </div>
                                    </div>
                                    <table class="w-100">
                                        <tr>
                                            <td align="center" colspan="4">
                                                Submit a a News wiith details to the Editor,He will verify and publish the news</td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                &nbsp;</td>
                                            <td>
                                                <asp:TextBox ID="TextBox16" runat="server" CssClass="css-input7" Height="60px" 
                                                    PlaceHolder="News Title" Width="800px" TextMode="MultiLine"></asp:TextBox>
                                            </td>
                                            <td>
                                                &nbsp;</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBox15" runat="server" CssClass="css-input7" 
                                                    PlaceHolder=" News Description" TextMode="MultiLine" 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Button ID="Button5" runat="server" class="button33" Height="60px" 
                                                    onclick="Button5_Click" Text="SEND" Width="400px" />
                                            </td>
                                            <td>
                                                &nbsp;</td>
                                            <td>
