<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_case.aspx.cs" Inherits="ABOUT" EnableEventValidation="false"%>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="adminhome.aspx" class="active">Home</a></li>
           <li><a href="admin_case.aspx">Complaints</a></li>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="center" class="text-left" rowspan="2">
                                                                                                    ...
                                                                                                    <asp:ImageButton ID="ImageButton1" runat="server" BorderColor="#996633" 
                                                                                                        ...
                                                                                                        CssClass="imageb" Height="100px" ImageUrl='<%# "user.ashx?id="+Eval("uid") %>' 
                                                                                                        onclick="ImageButton1_Click" oncommand="ImageButton1_Command" Width="100px" />
                                                                                                    </span>
                                                                                                </td>
                                                                                                <td class="text-left" rowspan="5">
                                                                                                    ...
                                                                                                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="10pt" 
                                                                                                        ForeColor="#000099" Text='<%# DataBinder.Eval(Container.DataItem,"uname") %>'></asp:Label>
                                                                                                    ,
