...
public partial class ABOUT : System.Web.UI.Page
{
    ...
    {
        cd.Open();
        string ss = "select max(did) from donor";
        ...
        string sss = "insert into donor values('" + s2.ToString() + "','" + TextBox1.Text + "','" + TextBox11.Text + "','" + TextBox11.Text + "','" + TextBox11.Text + "','" + TextBox11.Text + "','" + TextBox11.Text + "','" + TextBox11.Text + "','" + TextBox11.Text + "','" + TextBox2.Text + "','" + TextBox6.Text + "','" + TextBox6.Text + "',@img1,@img1)";
