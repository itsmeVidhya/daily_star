...
public partial class ABOUT : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string s11 = "select * from usercase where uid='"+Session["uid"].ToString()+"' order by cid desc";// where sid='"+Session["sid"].ToString()+"'";// where status='" + dd.ToString() + "'";// where grp='" + DropDownList1.SelectedItem.Text + "'";// order by pid desc";// where au='" + TextBox1.Text + "' ";
    ...
    protected void Button4_Command(object sender, CommandEventArgs e)
    {
        ...
        string sdw = "delete from usercase where cid='" + e.CommandArgument.ToString() + "'";// where uid='" + Session["uid"].ToString() + "'";// where pwd='" + f.ToString() + "' and pwd='" + TextBox1.Text + "' ";
