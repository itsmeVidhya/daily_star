<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_view_police.aspx.cs" Inherits="ABOUT" EnableEventValidation="false"%>
                                                                                ...
                                                                                <td align="center" class="style2">
                                                                                    <div class="polaroid5">
                                                                                        <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CC6600" 
                                                                                            ...
                                                                                            CssClass="imageb" Height="200px" ImageUrl='<%# "pol.ashx?id="+Eval("pid") %>' 
                                                                                        ...
                                                                                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" 
                                                                                            ForeColor="Black" Text='<%# DataBinder.Eval(Container.DataItem,"loc") %>'></asp:Label>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
