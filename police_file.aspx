<%@ Page Language="C#" AutoEventWireup="true" CodeFile="police_file.aspx.cs" Inherits="ABOUT" EnableEventValidation="false"%>
                                                                                ...
                                                                                <td align="center" class="style2">
                                                                                    <div class="polaroid51">
                                                                                        <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CC6600" 
                                                                                            ...
                                                                                            CssClass="imageb1" Height="240px" ImageUrl='<%# "news.ashx?id="+Eval("cid") %>' 
                                                                                        ...
                                                                                        <asp:Label ID="Label8" runat="server" Font-Bold="True" ForeColor="#003366" 
                                                                                            Text='<%# DataBinder.Eval(Container.DataItem,"ad") %>'></asp:Label>
                                                                                        <br />
                                                                                        <asp:LinkButton ID="LinkButton1" runat="server" 
                                                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem,"cid") %>' 
                                                                                            onclick="LinkButton1_Click1" oncommand="LinkButton1_Command1">Read More....</asp:LinkButton>
                                                                                        <br />
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
