<%@ Page Language="C#" AutoEventWireup="true" CodeFile="policehome.aspx.cs" Inherits="ABOUT" %>
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            <td align="center" colspan="4">
                                                Latest News from Reporters<br /></td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="center" class="text-left" rowspan="2">
                                                                                        ...
                                                                                        <asp:ImageButton ID="ImageButton1" runat="server" BorderColor="#996633" 
                                                                                            ...
                                                                                            ImageUrl='<%# "re.ashx?id="+Eval("uid") %>' onclick="ImageButton1_Click" 
