<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_view_police1.aspx.cs" Inherits="ABOUT" EnableEventValidation="false"%>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="admin_police_view.aspx">Police Station</a></li>
           <li><a href="admin_add_police.aspx">Add Police Station</a></li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table class="w-100">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        Contact Number of Incharge</td>
                                                                    <td>
                                                                        &nbsp;</td>
                                                                    <td>
                                                                        Official Address of Station</td>
                                                                    <td>
                                                                        &nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="TextBox15" runat="server" CssClass="css-input7" 
                                                                            PlaceHolder="Official Address" TextMode="MultiLine" Width="400px"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        &nbsp;</td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="Button5" runat="server" class="button33" Height="60px" 
                                                                            onclick="Button6_Click" Text="UPDATE" Width="400px" />
                                                                    </td>
                                                                    <td>
                                                                        &nbsp;</td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Button ID="Button6" runat="server" class="button33" Height="60px" 
                                                                            onclick="Button5_Click" Text="UPDATE" Width="400px" />
                                                                    </td>
                                                                    <td>
                                                                        &nbsp;</td>
                                                                </tr>
