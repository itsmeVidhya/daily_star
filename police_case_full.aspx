<%@ Page Language="C#" AutoEventWireup="true" CodeFile="police_case_full.aspx.cs" Inherits="ABOUT" EnableEventValidation="false" %>
                                ...
                                <asp:Panel ID="Panel2" runat="server" BorderColor="" BorderStyle="Solid" 
                                    ...
                                    <div class="text-center">
                                        <div class="">
                                            ...
                                            <br />
                                            <h2>
                                                News ID.<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>&nbsp;</h2>                                 </div>
                                    </div>
                                    <table class="w-100">
                                        <tr>
                                                                            ...
                                                                            <table class="nav-justified">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        ...
                                                                                        <br />
                                                                                        <asp:Button ID="Button5" runat="server" class="button33" 
                                                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem,"cid") %>' 
                                                                                            Height="60px" onclick="Button5_Click" oncommand="Button4_Command" 
                                                                                            Text='<%# "PUBLISH NEWS" %>' Width="400px" />
                                                                                        <br />
                                                                                        <asp:Button ID="Button6" runat="server" class="button33" 
                                                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem,"cid") %>' 
                                                                                            Height="60px" onclick="Button5_Click" oncommand="Button41_Command" 
                                                                                            Text='<%# "REJECT NEWS" %>' Width="400px" />
                                                                                        </span></span>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
