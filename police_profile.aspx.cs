...
public partial class ABOUT : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            cd.Open();
            String s11a = "select * from editor where eid='" + Session["poid"].ToString() + "'";
            ...
            if (r11a.Read() == true)
            {
                ...
                Image1.ImageUrl = "edi.ashx?id=" + r11a[0].ToString();
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        string sdw = "update editor set ename ='" + TextBox1.Text + "',ad='" + TextBox11.Text + "',cno='" + TextBox8.Text + "',desi='" + TextBox3.Text + "',email='" + TextBox2.Text + "' where eid='" + Session["poid"].ToString() + "'";// where pwd='" + f.ToString() + "' and pwd='" + TextBox1.Text + "' ";
    ...
    protected void Button69_Click(object sender, EventArgs e)
    {
        ...
        string sdw = "update editor set pic= @img where eid='" + Session["poid"].ToString() + "'";
        SqlCommand cmdw = new SqlCommand(sdw, cd);
        ...
        cd.Close();
        Response.Redirect("police_profile.aspx");
    }
}