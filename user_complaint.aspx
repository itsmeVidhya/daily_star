<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_complaint.aspx.cs" Inherits="ABOUT" EnableEventValidation="false" %>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
       <ul>
          ...
          <li><a href="user_complaint.aspx" class="active">My News</a></li>
          <li><a href="user_criminal.aspx">Profile</a></li>
          <li><a href="user_change.aspx">Change Password</a></li>
                                ...
                                <asp:Panel ID="Panel2" runat="server" BorderColor="" BorderStyle="Solid" 
                                    ...
                                    <div class="text-center">
                                        <div class="">
                                            ...
                                            <br />
                                            <h2>
                                                Hai Ms/Mrs.<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>,Your 
                                                News Details 
                                             </h2>                                 </div>
                                    </div>
                                    <table class="w-100">
                                        <tr>
                                            <td align="center" colspan="4">
                                                In the status section,you can view the updated information about your </td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table class="nav-justified">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        &nbsp;STATUS : <span><span style="font-size: small">
                                                                                        <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="16pt" 
                                                                                            ForeColor="#006600" Text='<%# DataBinder.Eval(Container.DataItem,"stat") %>'></asp:Label>
                                                                                        <br />
                                                                                        <asp:Button ID="Button4" runat="server" class="button33" 
                                                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem,"cid") %>' 
                                                                                            Height="60px" onclick="Button5_Click" oncommand="Button4_Command" 
                                                                                            Text='<%# "DELETE NEWS" %>' Width="400px" />
                                                                                        </span></span>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
