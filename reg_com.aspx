<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reg_com.aspx.cs" Inherits="ABOUT" %>
                                ...
                                <asp:Panel ID="Panel2" runat="server" BorderColor="" BorderStyle="Solid" 
                                    ...
                                    <div class="text-center">
                                        <div class="">
                                            ...
                                            <br />
                                            <h2>
                                                 YOU CAN LOGIN NOW</h2>
                                        </div>
                                    </div>
                                    <table class="w-100">
                                        <tr>
                                            <td align="center" colspan="4">
                                                &nbsp;You can login to your email id and password entered at the time of registration</td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="TextBox12" runat="server" CssClass="css-input7" 
                                                    PlaceHolder="Emai Id" Width="400px"></asp:TextBox>
                                            </td>
                                            <td>
                                                &nbsp;</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="Button4" runat="server" class="button33" Height="60px" 
                                                    onclick="Button5_Click" Text="LOGIN" Width="400px" />
                                            </td>
                                            <td>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                                            <td>
