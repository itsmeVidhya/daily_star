...
public partial class ABOUT : System.Web.UI.Page
{
    ...
    {
        cd.Open();
        string ss = "select max(rid) from reporter";
        ...
        string sss = "insert into reporter values('" + s2.ToString() + "','" + TextBox1.Text + "','" + TextBox17.Text + "','" + TextBox13.Text + "','" + TextBox3.Text + "','" + TextBox16.Text + "','" + TextBox5.Text + "',@img1)";
