<%@ Page Language="C#" AutoEventWireup="true" CodeFile="police_criminal.aspx.cs" Inherits="ABOUT" %>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="police_criminal.aspx" class="active">Criminal Records</a></li>
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            <td align="center" colspan="4">
                                                Search the crimianl background of a person<br />
                                                <asp:TextBox ID="TextBox1" runat="server" CssClass="css-input7" 
                                                    PlaceHolder="ID Card/Adhar Card Number" Width="400px"></asp:TextBox>
                                                <asp:Button ID="Button5" runat="server" class="button33" Height="50px" 
                                                    onclick="Button5_Click" Text="SEARCH" Width="200px" />
                                                <br /></td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                                                    ...
                                                                    <td align="center" class="style2">
                                                                        <div class="polaroid5">
                                                                            <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CC6600" 
                                                                                ...
                                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem,"crid") %>' 
                                                                                CssClass="imageb" Height="200px" ImageUrl='<%# "cr.ashx?id="+Eval("crid") %>' 
                                                                                onclick="ImageButton1_Click1" oncommand="ImageButton1_Command1" Width="200px" />
                                                                            <br />
                                                                            <asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="#003366" 
                                                                                Text='<%# DataBinder.Eval(Container.DataItem,"crname") %>'></asp:Label>
                                                                            <br />
                                                                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" 
                                                                                ForeColor="Black" Text='<%# DataBinder.Eval(Container.DataItem,"firno") %>'></asp:Label>
                                                                            <br />
                                                                            <span>
                                                                            <asp:LinkButton ID="LinkButton2" runat="server" 
                                                                                CommandArgument='<%# DataBinder.Eval(Container.DataItem,"crid") %>' 
                                                                                ForeColor="#FF3300" onclick="LinkButton1_Click" oncommand="LinkButton1_Command" 
