<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_reporter.aspx.cs" Inherits="ABOUT" EnableEventValidation="false"%>
                                                                                ...
                                                                                <td align="center" class="style2">
                                                                                    <div class="polaroid5">
                                                                                        <asp:ImageButton ID="ImageButton2" runat="server" BorderColor="#CC6600" 
                                                                                            ...
                                                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem,"rid") %>' 
                                                                                            CssClass="imageb" Height="200px" ImageUrl='<%# "re.ashx?id="+Eval("rid") %>' 
                                                                                        ...
                                                                                        <asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="#003366" 
                                                                                            Text='<%# DataBinder.Eval(Container.DataItem,"rname") %>'></asp:Label>
                                                                                        <br />
