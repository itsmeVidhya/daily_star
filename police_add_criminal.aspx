<%@ Page Language="C#" AutoEventWireup="true" CodeFile="police_add_criminal.aspx.cs" Inherits="ABOUT" %>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="police_add_criminal.aspx" class="active">Add Criminal Records</a></li>
                                    ...
                                    <table class="w-100">
                                        <tr>
                                            <td align="center" colspan="4">
                                                Add Criminal Record about a person to check by the citizens<br /></td>
                                            <td>
                                                &nbsp;</td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table class="w-100">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                            <asp:TextBox ID="TextBox12" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="Name" Width="800px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="TextBox14" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="Id Card Number / Adhar Card Id Number" Width="800"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="TextBox1" runat="server" CssClass="css-input7" 
                                                                PlaceHolder="FIR Number" Width="800"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
